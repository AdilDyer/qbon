...
const OurMoto = () => {
  return (
    <div className="ourMotoDiv">
      <h5>&#9786; Dear Fellow Brothers and Sisters,</h5>
      <h5>
        We hope this message finds you well and thriving in your academic
        journey.
      </h5>
      <h5>
      ...
      <span>
        ...
        <h5>
          ...
          comprehensive repository of question papers, study guides, and other
          academic resources. By sharing your own materials and insights, you
          have the power to make a difference in the lives of countless fellow
          students.
        </h5>
      </span>
      <h5>
      ...
      <h5>
        ...
        collective growth and success. Your support means the world to us, and
